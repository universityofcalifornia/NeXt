...
class EventTest < ActiveSupport::TestCase
    ...
    test 'validations' do
      ...
      assert_nothing_raised(ActiveRecord::RecordInvalid){ Event.new(name: "test", short_description: "test", start_datetime: DateTime.now, stop_datetime: 10.days.from_now ).save! }
